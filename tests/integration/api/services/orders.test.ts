...
import { markServicePurchasePaid } from "@server/lib/commerce";
...
describe.skipIf(!dbAvailable)("service publication lifecycle", () => {
...
describe.skipIf(!dbAvailable)("service order data", () => {
...
describe.skipIf(!dbAvailable)("service delivery, revisions, acceptance and dispute", () => {
