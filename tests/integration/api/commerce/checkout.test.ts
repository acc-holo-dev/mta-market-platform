...
import { validateDiscount } from "@server/lib/discount";
...
describe.skipIf(!dbAvailable)("free resource checkout flow", () => {
...
describe.skipIf(!dbAvailable)("discount validation and snapshot", () => {
...
describe.skipIf(!dbAvailable)("single-use coupon under concurrency", () => {
