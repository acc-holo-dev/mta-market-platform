...
describe.skipIf(!dbAvailable)("payment state machine", () => {
...
describe.skipIf(!dbAvailable)("double-entry ledger", () => {
  it("settlement posts a balanced transaction: cash = seller + platform", async () => {
    ...
    await import("@server/lib/ledger").then((m) => m.settlePurchaseRevenue(purchase!));
...
describe.skipIf(!dbAvailable)("free orders create no money movement", () => {
...
describe.skipIf(!dbAvailable)("refund lifecycle", () => {
