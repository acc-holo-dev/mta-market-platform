...
describe.skipIf(!dbAvailable)("server news", () => {
...
describe.skipIf(!dbAvailable)("server updates", () => {
...
describe.skipIf(!dbAvailable)("notification center", () => {
...
describe.skipIf(!dbAvailable)("dashboard community widgets", () => {
