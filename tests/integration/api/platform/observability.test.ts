...
describe.skipIf(!dbAvailable)("request id / tracing", () => {
...
describe.skipIf(!dbAvailable)("honest pagination", () => {
...
describe.skipIf(!dbAvailable)("admin statistics via aggregates", () => {
