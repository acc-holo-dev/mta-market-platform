...
describe.skipIf(!dbAvailable)("community hub & categories", () => {
...
describe.skipIf(!dbAvailable)("threads & posts", () => {
...
describe.skipIf(!dbAvailable)("community reports", () => {
...
describe.skipIf(!dbAvailable)("server-linked discussions", () => {
